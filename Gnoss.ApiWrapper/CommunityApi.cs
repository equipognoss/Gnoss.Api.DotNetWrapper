...
namespace Gnoss.ApiWrapper
{
    ...
    public class CommunityApi : GnossApiWrapper
    {
        ...
        public CommunityApi(OAuthInfo oauth, string communityShortName) : base(oauth, communityShortName)
        {
        ...
        internal List<ThesaurusCategory> LoadCategories(string community_short_name)
        {
            ...
            LogHelper.Instance.Debug($"Loaded the categories of the communtiy {community_short_name}");
        ...
        public void CreateCommunity(CommunityModel communityModel)
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"Community created {json}");
            }
            catch (Exception ex)
            {
        ...
        public void CreateThesaurus(string thesaurusXml)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Thesaurus created in {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error creating thesaurus {thesaurusXml} in {CommunityShortName}: \r\n {ex.Message}");
                throw;
            }
        }
        ...
        public void OpenCommunity()
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Community opened {CommunityShortName}");
            }
            catch (Exception ex)
            {
        ...
        public void UploadConfiguration(string settingsXml)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Settings uploaded successfully to {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error uploading settings to community {CommunityShortName} {settingsXml}: \r\n {ex.Message}");
                throw;
            }
        }
        ...
        public void UploadCMSConfiguration(string settingsCmsXml)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"CMS settings uploaded successfully to {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error uploading the CMS settings to community {CommunityShortName} {settingsCmsXml}: \r\n {ex.Message}");
                throw;
            }
        }
        ...
        public void AddMember(Guid userId, string organizationShortName = null, short identityType = 0)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"User {userId} added to {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error adding member {userId} to {CommunityShortName}: {ex.Message} ");
                throw;
            }
        }
        ...
        public void DeleteMember(Guid userId)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Member {userId} deleted from {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error deleting member {userId} from {CommunityShortName}: {ex.Message} ");
                throw;
            }
        }
        ...
        public void AddMemberOrganizationGroupToCommunity(string organizationShortName, string groupShortName, short identityType)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"The group {groupShortName} of {organizationShortName} has been added to {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error adding the group {groupShortName} of {organizationShortName} from {CommunityShortName}: {ex.Message} ");
                throw;
            }
        }
        ...
        public void DeleteMemberOrganizationGroupFromCommunity(string organizationShortName, string groupShortName)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"All the members from the group {groupShortName} of {organizationShortName} has been deleted to {CommunityShortName}");

            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error deleting the group members {groupShortName} of {organizationShortName} from {CommunityShortName}: {ex.Message} ");
                throw;
            }
        }
        ...
        public void UpgradeMembersOrganizationGroupToAdministrators(string organizationShortName, string groupShortName)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"All the members from the group { groupShortName} of { organizationShortName} has been upgraded to administrator in { CommunityShortName}. \r\n{result}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error upgrading to administrator the members from the group { groupShortName} of { organizationShortName} in { CommunityShortName}: {ex.Message}");
                throw;
            }
        }
        ...
        public void CreateCommunityGroup(string groupName, string groupShortName, string description, List<string> tags, List<Guid> members, bool sendNotification = false)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Group {groupName} created in {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error creating group {groupName} in {CommunityShortName}: {ex.Message}");
                throw;
            }
        }
        ...
        public void DeleteCommunityGroup(string groupShortName)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Group {groupShortName} deleted in {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error deleting group {groupShortName} in {CommunityShortName}: {ex.Message}");
                throw;
            }
        }
        ...
        public void AddMembersToGroup(string groupShortName, List<Guid> members, bool sendNotification = false)
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"The users has been added to the group {groupShortName} of the communtiy {CommunityShortName}");
            }
            catch (Exception ex)
            {
        ...
        public void DeleteMembersFromGroup(string groupShortName, List<Guid> members)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"The users has been deleted from the group {groupShortName} of the communtiy {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error deleting users {string.Join(",", members)} from group {groupShortName} of the community {CommunityShortName}: \r\n{ex.Message}");
                throw;
            }
        }
        ...
        public List<Guid> GetGroupMembers(string groupShortName)
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"Users obtained from group {groupShortName} of the community {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error obtaining users from group {groupShortName} of the community {CommunityShortName}: \r\n{ex.Message}");
                throw;
            }
            return members;
        }
        ...
        public List<Guid> GetOrganizationGroupMembers(string organizationShortName, string groupShortName)
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"Users obtained from group {groupShortName} of the organization {organizationShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error obtaining users from group {groupShortName} of the organization {organizationShortName}: \r\n{ex.Message}");
                throw;
            }
            return members;
        }
        ...
        public void ExpelMember(Guid userId)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"User {userId} expelled from {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error expelling member {userId} from {CommunityShortName}: {ex.Message}");
                throw;
            }
        }
        ...
        public void CloseCommunity()
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Community {CommunityShortName} closed");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error closing {CommunityShortName}: {ex.Message}");
                throw;
            }
        }
        ...
        public void ChangeCommunityName(string newName)
        {
            try
            {
                ...
                LogHelper.Instance.Debug($"Community name of {CommunityShortName} changed to {newName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error changing name of {CommunityShortName} to {newName}: {ex.Message}");
                throw;
            }
        }
        ...
        public List<GroupCommunityModel> GetCommunityGroups()
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"Groups obtained from {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error obtaining groups from {CommunityShortName}: \r\n{ex.Message}");
                throw;
            }
            return groups;
        }
        ...
        public string GetOrganizationShortNameFromMember(string userId)
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"Organization short name obtained from {userId} in {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error obtaining the organization short name from {userId} in {CommunityShortName}: \r\n{ex.Message}");
                throw;
            }
        ...
        public List<ExtraRegisterData> GetExtraRegisterData()
        {
            ...
            try
            {
                ...
                LogHelper.Instance.Debug($"Extra register data obtained from {CommunityShortName}");
            }
            catch (Exception ex)
            {
                LogHelper.Instance.Error($"Error obtaining extra register data from {CommunityShortName}: \r\n{ex.Message}");
                throw;
            }
        ...
        public string GetCommunityMainLanguage()
        {
            ...
            {
                LogHelper.Instance.Error("Imposible to obtain the main language");
                return null;
            }
        }
        ...
        public Dictionary<Guid, string> GetCommunityPersonIDEmail()
        {
            ...
            {
                LogHelper.Instance.Error($"The person identifiers and emails of the community members '{CommunityShortName}' could not be obtained" );
                return null;
            }
        }
        ...
        public Guid GetCommunityId(string communityShortName)
        {
            ...
            {
                LogHelper.Instance.Error($"The community {communityShortName} could not be found");
                throw;
            }
        }
        ...
        public CommunityInfoModel GetCommunityInfo(Guid communityId)
        {
            ...
            {
                LogHelper.Instance.Error($"The community {communityId} could not be found");
                throw;
            }
        }
        ...
        public CategoryNames GetCategoryName(Guid categoryId)
        {
            ...
            {
                LogHelper.Instance.Error($"The category {categoryId} could not be found");
                throw;
            }
        }
