...
namespace Gnoss.ApiWrapper.Model
{
    ...
    public sealed class ConceptEntity : SecondaryEntity
    {
        ...
        public ConceptEntity(string identifierNameRoot, string identifier, string dcSource, Dictionary<string, string> prefLabelDictionary, List<ConceptEntity> subentities, string parentIdentifier, string GraphsUrl, int level = 1)
        {
